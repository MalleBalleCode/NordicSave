...
//
// Registreringssida. Anropar /api/auth/register för att skapa kontot,
// loggar sedan in automatiskt med signIn() och skickar till /dashboard.
...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: FormEvent<HTMLFormElement>) {
    ...
    // Steg 1: Skapa kontot via vår API-route
    ...
    // Steg 2: Logga in automatiskt efter att kontot skapats
    ...
    if (result?.error) {
      // Kontot skapades men inloggningen misslyckades – skicka till login
      router.push("/login");
      return;
    }

    // Klart! Välkommen till dashboarden.
    ...
    <div className="min-h-screen bg-surface flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-sm">
          ...
          >
            {/* Badge – no cure no pay */}
            <div className="flex justify-center mb-6">
              <span className="inline-flex items-center gap-2 rounded-full border border-gain/30 bg-gain/[0.08] px-3 py-1 text-xs font-medium text-gain_dark">
                Gratis att komma igång · Du betalar bara om vi lyckas
              </span>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                >
                  Lösenord{" "}
                  <span className="text-muted font-normal">(minst 8 tecken)</span>
                </label>
                <input
                  id="password"
                  type="password"
            ...
            <p className="mt-4 text-center text-xs text-muted">
              ...
              <span className="text-ink_soft">villkor och vår integritetspolicy</span>.
            </p>
          </form>
        </div>
      </main>
