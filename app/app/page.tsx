    ...
    <main className="min-h-screen bg-surface">
      ...
      <section className="relative ledger-grid overflow-hidden border-b border-line">
        <div className="max-w-content mx-auto px-6 sm:px-8 py-16 sm:py-24 grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          <div>
            <p className="inline-flex items-center gap-2 rounded-full border border-gain/30 bg-gain/[0.08] px-3 py-1 text-xs font-medium text-gain_dark mb-6">Inga förpliktelser · Du betalar bara om vi lyckas</p>
            <h1 className="font-display font-extrabold tracking-tightest text-ink text-4xl sm:text-5xl lg:text-[3.4rem] leading-[1.05] mb-6">Du betalar för mycket för bredband och streaming. <span className="text-action">Vi fixar det.</span></h1>
            <p className="text-lg text-ink_soft leading-relaxed mb-8 max-w-md">NordicSave analyserar dina avtal, förhandlar med leverantörerna och sänker din månadskostnad. Du lägger 2 minuter — vi sköter resten.</p>
      ...
      <section className="max-w-content mx-auto px-6 sm:px-8 py-16 sm:py-24">
        <h2 className="font-display font-bold tracking-tightest text-ink text-2xl sm:text-3xl mb-12 max-w-lg">Tre steg. Ingen risk för dig.</h2>
      ...
      <section id="lead-form" className="border-t border-line bg-white">
        <div className="max-w-content mx-auto px-6 sm:px-8 py-16 sm:py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="font-display font-bold tracking-tightest text-ink text-2xl sm:text-3xl mb-4">Redo att sänka din räkning?</h2>
            <p className="text-ink_soft leading-relaxed max-w-md">Lämna dina uppgifter och vi återkommer med en kostnadsfri analys av vad du kan spara — utan förpliktelser.</p>
          </div>
          <LeadForm />
        </div>
      </section>
